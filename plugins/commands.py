...
async def start(client, message):
    ...
    if data.split("-", 1)[0] == "UHD":
        user_id = int(data.split("-", 1)[1])
        UHD = await referal_add_user(user_id, message.from_user.id)
        if UHD and PREMIUM_AND_REFERAL_MODE == True:
            ...
            try:
                ...
                if STREAM_MODE == True:
                    button = [[
                        ...
                        InlineKeyboardButton('𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥', url="https://t.me/UHDOWNERBOT")
                    ],[
        ...
        for file in files:
            ...
            if STREAM_MODE == True:
                button = [[
                    ...
                    InlineKeyboardButton("𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥", url="t.me/UHDOWNERBOT")
                ],[
